...
def main():
    ...
    na1 = create_rpi3_node(name='eb-a-rpi4-1', ip_address='192.168.1.58', virtual_ip_address='10.0.1.58')
    na2 = create_rpi3_node(name='eb-a-rpi3-1', ip_address='192.168.1.54', virtual_ip_address='10.0.1.54')
    ...
    nb3 = create_rpi3_node(name='eb-a-xeongpu-0', ip_address='192.168.0.122', virtual_ip_address='10.0.2.60')
    ...
    ca0 = WgRouter(tags={'name': 'eb-a-controller', 'type': 'Router'}, ip_address='192.168.1.2', virtual_ip_address='10.0.1.2', allowed_ip_range=["10.0.1.0/26"])
    cb0 = WgRouter(tags={'name': 'eb-b-controller', 'type': 'Router'}, ip_address='192.168.1.101', virtual_ip_address='10.0.1.12', allowed_ip_range=["10.0.1.64/26, 10.0.2.0/24"])
    cc0 = WgRouter(tags={'name': 'eb-c-vm-0', 'type': 'Router'}, ip_address='128.131.57.149', virtual_ip_address='10.0.3.1', allowed_ip_range=["10.0.3.0/24"])

    topology.add_connection(Connection(na0, ca0, 1))
    topology.add_connection(Connection(na1, ca0, 1))
    topology.add_connection(Connection(na2, ca0, 1))
    topology.add_connection(Connection(na3, ca0, 1))
    topology.add_connection(Connection(na4, ca0, 1))
    topology.add_connection(Connection(na5, ca0, 1))

    topology.add_connection(Connection(nb0, cb0, 1))
    topology.add_connection(Connection(nb1, cb0, 1))
    topology.add_connection(Connection(nb2, cb0, 1))
    topology.add_connection(Connection(nb3, cb0, 1))
    topology.add_connection(Connection(nb4, cb0, 1))

    topology.add_connection(Connection(nc0, cc0, 1))
    topology.add_connection(Connection(nc1, cc0, 1))
    topology.add_connection(Connection(nc2, cc0, 1))
