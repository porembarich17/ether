...
def main():
    ...
    n1 = create_rpi3_node(ip_address='192.168.0.10', virtual_ip_address='11.0.0.1')
    ...
    l0 = Link(tags={'name': 'Router', 'type': 'Router'}, ip_address='192.168.0.192', virtual_ip_address='10.0.0.222', allowed_ip_range=["10.0.0.0/24, 11.0.0.0/24"])
